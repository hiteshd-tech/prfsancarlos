...
if (!empty($reviews)) {
    foreach ($reviews as $index => $review) {
        ...
        ?>
            <div class="wpsr-review-template wpsr-review-template-ten <?php echo ($review->platform_name) ? 'wpsr-review-template-' . esc_attr($review->platform_name) : ''; ?>"
                        ...
                        <div class="wpsr-review-info-column">
                            ...
                            <div class="wpsr-reviewer-name-row">
                                ...
                                do_action('wpsocialreviews/reviewer_name', $template_meta['reviewer_name'],
                                    $reviewer_url, $review->reviewer_name, $enableExternalLink, $review->platform_name, $template_meta['enable_verified_badge'], $template_meta['verified_badge_tooltip_text']);
                                ?>

                                <!-- Row 1: Date -->
                                <?php if($review->category !== 'ai_summary' && $review->platform_name !== 'ai'): ?>
                            ...
                            <div class="wpsr-review-content-row">
                                 ...
                                 * */
                                 ...
                                 if(
                                    $template_meta['ai_summary']['enabled'] === 'true' 
                                    ...
                                    do_action('wpsocialreviews/review_images', $reviewImages, $review->id);
                                }
                                ?>
                            </div>
                        </div>
