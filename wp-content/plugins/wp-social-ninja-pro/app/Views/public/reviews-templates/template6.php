...
$enableVerifiedBadge = Arr::get($template_meta, 'enable_verified_badge', 'false');
if (!empty($reviews)) {
            ...
            >
                ...
                ?>
                    <div class="wpsr-review-info">
                         ...
                         * */
                        do_action('wpsocialreviews/reviewer_name', $template_meta['reviewer_name'], $reviewer_url, $review->reviewer_name, $enableExternalLink, $review->platform_name, $enableVerifiedBadge, $template_meta['verified_badge_tooltip_text']);
