=== WP Social Ninja Pro – Social Feed, Reviews & Chat Plugin for WP (Google Reviews, Photo Feeds & More) ===
...
1. WP Social Ninja Dashboard: Embed Business Reviews, Social Feeds, Chat Widgets, and More.
2. Easy Onboarding and QuickBuilder for a Smooth User Journey
3. Display Instagram Feeds with Prebuilt Templates, Layouts, and Styling Options
4. Embed Different Facebook Feed Types with Deep Customization Options
5. Quick and Easy YouTube Feed for Video Promotion
6. Display TikTok Feeds WP Social Ninja That Actually Drive Business Results
7. Embed Google Review Feed for Better Engagement, SEO & Sales
8. Connect WhatsApp, Messenger, Telegram, and More for Instant Chat Support
9. Fine-tune Your Feeds with Granular Control over Appearance, Content, and Performance.
10. Deliver Flawless User Experiences While Climbing Search Rankings Automatically
...
- Fixed Uncaught Error: Call to a member function get_ID() on null in actions.php when the woocommerce_comments called.
- Fixed facebook event feed order issue
...
- Fixed compatibility issue with the Facebook Event API.
- Improved Judge.me review import process and fixed review display issues inside the product reviews tab.
- Added fancy text support to faceebook feed filters.
- Displayed place id for Airbnb business names to help distinguish between businesses with the same name.
- Displayed Airbnb business place id in the business selection dropdown to avoid confusion when multiple businesses share the same name.
- Added missing translator strings and translator comments.
- Fixed Trustpilot review update issue and improved review field selection logic.
...
- Fixed PHP 8.1 compatibility issue caused by automatic conversion of false to array.
...
- Resolved an issue where the "Posts Order by Most Popular" and "Posts Order by Least Popular" options in Facebook feeds were not functioning correctly. Filters now work as expected, displaying posts based on popularity.
- Updated TikTok Feed Template 2 to be GDPR-compliant and optimized for image loading.
- Fixed the average rating display to show a maximum of one decimal number.
