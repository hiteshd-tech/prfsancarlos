...
class CWMWPAdmin {
	...
	function removeAdminNotices() {
		if (CWMHelper::getRawParam('REQUEST', 'page') === $this->bvinfo->plugname) {
	...
	public function siteInfoTags() {
		...
		$public = CWMAccount::getApiPublicKey($this->settings);
		$server_ip = CWMHelper::getStringParamEscaped('SERVER', 'SERVER_ADDR', 'attr');
