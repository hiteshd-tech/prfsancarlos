...
if (!class_exists('CWMWPAction')) :
	class CWMWPAction {
		...
		public function __construct($settings, $siteinfo, $bvapi) {
			...
			$this->bvapi = $bvapi;
			$this->bvinfo = new CWMInfo($settings);
		}
		...
		public static function uninstall() {
			...
			##CLEARDYNSYNCCONFIG##
			##CLEARCACHECONFIG##
			do_action('cwm_clear_bv_services_config');
			##CLEAR_WP_2FA_CONFIG##
