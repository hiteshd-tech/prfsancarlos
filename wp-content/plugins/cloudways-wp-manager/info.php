...
if (!class_exists('CWMInfo')) :
	class CWMInfo {
		public $settings;
		public $config;
		public $plugname = 'cloudways_wp_manager';
		public $brandname = 'Cloudways WP Manager';
		public $badgeinfo = 'cwmbadge';
		public $ip_header_option = 'cwmipheader';
		public $brand_option = 'cwmbrand';
		public $wp_lp_whitelabel_option = 'cwmLpWhitelabelConf';
		public $version = '6.31';
		public $webpage = 'https://www.cloudways.com';
		public $appurl = 'https://app.wpremote.com';
		public $slug = 'cloudways-wp-manager/cloudways_wp_manager.php';
		public $plug_redirect = 'cwmredirect';
		...
		public $title = 'Cloudways WP Manager';
		...
		public function hasValidDBVersion() {
			return CWMInfo::DB_VERSION === $this->getCurrentDBVersion();
		}
		...
		public function getConnectionKey() {
			...
			$secret = CWMRecover::defaultSecret($this->settings);
		...
		public function getDefaultSecret() {
			require_once dirname( __FILE__ ) . '/recover.php';
			$bvsiteinfo = new CWMWPSiteInfo();
			return CWMRecover::defaultSecret($this->settings);
		}
